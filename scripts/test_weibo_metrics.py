...
def parse_args():
    parser = argparse.ArgumentParser(description="Evaluate Weibo test set and print accuracy/precision/recall/f1")
    ...
    parser.add_argument("--out", type=str, default="weibo/test_metrics.json", help="Output json path")
